...
import { Loader2, LayoutDashboard, Package, Tags, ShoppingBag, FileText, LogOut, Printer, Images, FileSpreadsheet, ShieldCheck, ShieldAlert, SearchCheck } from "lucide-react";
...
export default function AdminLayout() {
  ...
  const nav = [
    ...
    { to: "/admin/diagnostico-imagens", label: "Diagnóstico imagens", icon: SearchCheck },
